...
import com.recon.dailyroutine.AdditionalClasses.ConnectionManager
import com.recon.dailyroutine.DataBase.MoodEntry


class MeditationActivity : AppCompatActivity() {
    private var mediaController: MediaController? = null
    lateinit var moodEnt: MoodEntry
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        energyBtn.setOnClickListener{
            if (ConnectionManager.isNetworkAvailable(this)) {
                ...
                Snackbar.make(energyBtn, "No INTERNET connection", Snackbar.LENGTH_SHORT)
                    .show()
            }
...
//        moodEnt = MoodEntry(1,9,"1st point","WORKS")
...
//    }
//    private suspend fun write_data(){
//        DBSingleton.database.moodDao().insertMoodEntry(moodEnt)
//    }
//    private suspend fun read_data(){
//        println(DBSingleton.database.moodDao().getAllMoodEntries())
//    }
}